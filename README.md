...
- Overview of the complete analysis workflow and quick setup guide
...
- **[Image Selection Methods](image_selection.md)** 
  - Learn 3 ways to select calibration/analysis images
  - Time intervals with equidistant sampling
  - Specific time points
  - Direct file path selection with wildcards
  
- **[Finger Analysis Setup](finger_analysis.md)** 
  - Configure fingering instability detection
  - Understanding modes (concentration, saturation)
  - Defining regions of interest (ROIs)
  - Practical configuration examples

### Utilities
- **[setup_imaging_protocol.py](utils/setup_imaging_protocol.py)** 
  - Extract EXIF timestamps from image files
...
5. Run example configurations from `config/`
...
- **Protocol files** - Excel/csv spreadsheets with timing/injection/pressure data
...
- **`exp_XXX.toml`** - Run-specific data (image folder, baseline, protocols)
...
**Last Updated**: 2026-04-29 | **Project Status**: Active Development